...
namespace Repository.Interface
{
    ...
    public interface IUnitWork
    {
        ...
        IQueryable<T> Find<T, S>(int pageindex, int pagesize, out int Total, Expression<Func<T, S>> orderby, Expression<Func<T, bool>> exp = null, bool isAsc = true) where T : class;
